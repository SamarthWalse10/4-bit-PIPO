...
REM
REM Generated by Vivado on Fri Dec 02 13:44:51 +0530 2022
...
echo "xvlog --incr --relax -prj pipo_4bit_tb_vlog.prj"
call xvlog  --incr --relax -prj pipo_4bit_tb_vlog.prj -log xvlog.log
